        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    highFade = 0.7f - ((0.7f - highFade) * (0.7f - highFade));
                    lowFade = 0.7f - ((0.7f - lowFade) * (0.7f - lowFade));
                    accFade = 0.7f - ((0.7f - accFade) * (0.7f - accFade));
                    decFade = 0.7f - ((0.7f - decFade) * (0.7f - decFade));
